...
public class Order extends BaseTest {
	...
	public void Order_01_Add_Product_To_Cart() {
		...
		log.info("Order_01 - Step 01: Select Dropdown 'Processor' with value is '2.5 GHz Intel Pentium Dual-Core E2200 [+$15.00]'");
		productsNamePage.selectToDropdownByNameAtProductNamePage("Processor", "2.5 GHz Intel Pentium Dual-Core E2200 [+$15.00]");

		log.info("Order_01 - Step 02: Select Dropdown 'RAM' with value is '2 GB'");
		productsNamePage.selectToDropdownByNameAtProductNamePage("RAM", "2 GB");

		log.info("Order_01 - Step 03: Click to 'HDD' Radio button with value is '400 GB [+$100.00]'");
		productsNamePage.clicktoRadioButtonByButtonNameAndValueName("HDD", "400 GB [+$100.00]");

		log.info("Order_01 - Step 04: Click to 'OS' Radio button with value is 'Vista Premium [+$60.00]'");
		productsNamePage.clicktoRadioButtonByButtonNameAndValueName("OS", "Vista Premium [+$60.00]");

		log.info("Order_01 - Step 05: Click to 'Software' Checkbox with value is 'Acrobat Reader [+$10.00]'");
		productsNamePage.clicktoCheckboxByButtonNameAndValueName("Software", "Acrobat Reader [+$10.00]");

		log.info("Order_01 - Step 06: Click to 'Software' Checkbox with value is 'Total Commander [+$5.00]'");
		productsNamePage.clicktoCheckboxByButtonNameAndValueName("Software", "Total Commander [+$5.00]");

		log.info("Order_01 - Step 07: Click to Add To Cart button");
		productsNamePage.clickAddToCartAtOverviewClass();

		log.info("Order_01 - Step 08: Verify add to cart success message is displayed ");
		Assert.assertTrue(productsNamePage.getAddSuccessMessage(driver).contains("The product has been added"));

		log.info("Order_01 - Step 09: Click to Close add to Cart success message");
		productsNamePage.clickToCloseAtToCartSuccessMessage();

		log.info("Order_01 - Step 10: Verify Quantity Shopping Cart link is '1' is displayed ");
		Assert.assertEquals(productsNamePage.isShoppingCartQtyByText("Shopping cart"), "(1)");

		log.info("Order_01 - Step 11:Hover to Shopping Cart Link");
		productsNamePage.hoverToShoppingCartLink();

		log.info("Order_01 - Step 12: Verify Mini Shopping Cart count is 'There are 1 item(s) in your cart.' is displayed ");
		Assert.assertEquals(productsNamePage.isMiniShoppingCartCount(), "There are 1 item(s) in your cart.");

		log.info("Order_01 - Step 13: Verify Mini Shopping Cart name is 'Build your own computer' is displayed ");
		Assert.assertEquals(productsNamePage.isMiniShoppingCartName(), "Build your own computer");

		log.info("Order_01 - Step 14: Verify Mini Shopping Cart Price is '$1,440.00' is displayed ");
		Assert.assertEquals(productsNamePage.isMiniShoppingCartPrice(), "$1,440.00");

		log.info("Order_01 - Step 15: Verify Mini Shopping Cart Quantity is '1' is displayed ");
		Assert.assertEquals(productsNamePage.isMiniShoppingCartQuantity(), "1");

		log.info("Order_01 - Step 16: Verify Mini Shopping Cart Sub Total is '$1,440.00' is displayed ");
		Assert.assertEquals(productsNamePage.isMiniShoppingCartSubTotal(), "$1,440.00");

		log.info("Order_01 - Step 17: Verify Mini Shopping Cart Attribute is 'Processor: 2.5 GHz Intel Pentium Dual-Core E2200 [+$15.00]' is displayed ");
		...
		log.info("Order_01 - Step 18: Verify Mini Shopping Cart Attribute is 'RAM: 2 GB' is displayed ");
		Assert.assertTrue(productsNamePage.isMiniShoppingCartAttribute().contains("RAM: 2 GB"));

		log.info("Order_01 - Step 19: Verify Mini Shopping Cart Attribute is 'HDD: 400 GB [+$100.00]' is displayed ");
		Assert.assertTrue(productsNamePage.isMiniShoppingCartAttribute().contains("HDD: 400 GB [+$100.00]"));

		log.info("Order_01 - Step 20: Verify Mini Shopping Cart Attribute is 'OS: Vista Premium [+$60.00]' is displayed ");
		Assert.assertTrue(productsNamePage.isMiniShoppingCartAttribute().contains("OS: Vista Premium [+$60.00]"));

		log.info("Order_01 - Step 21: Verify Mini Shopping Cart Attribute is 'Software: Microsoft Office [+$50.00]' is displayed ");
		Assert.assertTrue(productsNamePage.isMiniShoppingCartAttribute().contains("Software: Microsoft Office [+$50.00]"));

		log.info("Order_01 - Step 22: Verify Mini Shopping Cart Attribute is 'Software: Acrobat Reader [+$10.00] is displayed ");
		Assert.assertTrue(productsNamePage.isMiniShoppingCartAttribute().contains("Software: Acrobat Reader [+$10.00]"));

		log.info("Order_01 - Step 23: Verify Mini Shopping Cart Attribute is 'Software: Total Commander [+$5.00]' is displayed ");
	...
	public void Order_02_Edit_Product_In_Shopping_Cart() {
		...
		log.info("Order_02 - Step 01: Navigate to 'Shopping Cart' page");
		...
		log.info("Order_02 - Step 03: Enter to Product Qty textbox by Update Button ");
		productsNamePage.inputToQtyByButtonNameAtOverviewClass("Update", "2");
		;

		log.info("Order_02 - Step 04: Click to 'Update' button");
		productsNamePage.clickUpdateButtonAtOverviewClass();

		log.info("Order_02 - Step 05: Verify add to cart success message is displayed ");
		Assert.assertTrue(productsNamePage.getAddSuccessMessage(driver).contains("The product has been added"));

		log.info("Order_02 - Step 06: Click to Close add to Cart success message");
		productsNamePage.clickToCloseAtToCartSuccessMessage();

		log.info("Order_02 - Step 07: Verify Quantity Shopping Cart link is '2' is displayed ");
		Assert.assertEquals(productsNamePage.isShoppingCartQtyByText("Shopping cart"), "(2)");

		log.info("Order_02 - Step 08: Hover to Shopping Cart Link");
		productsNamePage.hoverToShoppingCartLink();

		log.info("Order_02 - Step 09: Verify Mini Shopping Cart Price is '$1,440.00' is displayed ");
		Assert.assertEquals(productsNamePage.isMiniShoppingCartPrice(), "$1,440.00");

		log.info("Order_02 - Step 10: Verify Mini Shopping Cart Quantity is '2' is displayed ");
		Assert.assertEquals(productsNamePage.isMiniShoppingCartQuantity(), "2");

		log.info("Order_02 - Step 11: Verify Mini Shopping Cart Sub Total is '$2,880.00' is displayed ");
		Assert.assertEquals(productsNamePage.isMiniShoppingCartSubTotal(), "$2,880.00");

		log.info("Order_02 - Step 12: Navigate to 'Shopping Cart' page");
		shoppingCartPage = productsNamePage.openShoppingCartPage();

		log.info("Order_02 - Step 13: Verify 'Qty' product is '2' is displayed ");
		Assert.assertEquals(shoppingCartPage.getValueTextBoxProductByColumnAtRowNumberatShoppingCart("Qty.", "1"), "2");

		log.info("Order_02 - Step 14: Verify 'Price' product is '$1,440.00' is displayed ");
		Assert.assertEquals(shoppingCartPage.getTextProductByColumnAtRowNumberatShoppingCart("Price", "1"), "$1,440.00");

		log.info("Order_02 - Step 15: Verify 'Total' product is '$2,880.00' is displayed ");
	...
	public void Order_03_Remove_From_Cart() {
		...
		log.info("Order_03 - Step 01: Click to Remove button at Shopping Cart");
		shoppingCartPage.clickButtonByColumnAtRowNumberatShoppingCart("Remove", "1");

		log.info("Order_03 - Step 02: Verify 'Your Shopping Cart is empty!' is displayed ");
		Assert.assertTrue(shoppingCartPage.getOrderSumuryContent().contains("Your Shopping Cart is empty!"));

		log.info("Order_03 - Step 03: Verify Quantity Shopping Cart link is '0' is displayed ");
		Assert.assertEquals(shoppingCartPage.getShoppingCartQtyByText("Shopping cart"), "(0)");

		log.info("Order_03 - Step 04: Hover to Shopping Cart Link");
		shoppingCartPage.hoverToShoppingCartLink();

		log.info("Order_03 - Step 05: Verify Mini Shopping Cart count is 'You have no items in your shopping cart.' ");
	...
	public void Order_04_Update_Shopping_Cart() {
		log.info("Order_04 - Step 01: Swith to 'Computers' page");
		computersPage = (UserComputersPageObject) shoppingCartPage.openpageAtHomePageByName(driver, "Computers");

		log.info("Order_04 - Step 02: Verify 'Computers' title is displayed ");
		Assert.assertTrue(computersPage.isPageTitleByText(driver, "Computers"));
		...
		log.info("Order_04 - Step 05: Click Product name  with  title " + productName1);
		productsNamePage = desktopsPage.clickToProductByText(driver, productName1);

		log.info("Order_04 - Step 06: Click to Add To Cart button");
		productsNamePage.clickAddToCartAtOverviewClass();

		log.info("Order_04 - Step 07: Verify add to cart success message is displayed ");
		Assert.assertTrue(productsNamePage.getAddSuccessMessage(driver).contains("The product has been added"));

		log.info("Order_04 - Step 08: Click to Close add to Cart success message");
		productsNamePage.clickToCloseAtToCartSuccessMessage();

		log.info("Order_04 - Step 09: Navigate to 'Shopping Cart' page");
		shoppingCartPage = productsNamePage.openShoppingCartPage();

		log.info("Order_04 - Step 10: Enter to 'Qty' product is '5' is displayed ");
		shoppingCartPage.inputToQtyByColumnAtRowNumberatShoppingCart("Qty.", "1", "5");

		log.info("Order_04 - Step 11: Click to 'Update  Shopping Cart' button");
		shoppingCartPage.clicktoShoppingCartButtonByTextName("Update shopping cart");

		log.info("Order_04 - Step 12: Verify 'Qty' product is '5' is displayed ");
		Assert.assertEquals(shoppingCartPage.getValueTextBoxProductByColumnAtRowNumberatShoppingCart("Qty.", "1"), "5");

		log.info("Order_04 - Step 13: Verify 'Total' product is '$2,500.00' is displayed ");
